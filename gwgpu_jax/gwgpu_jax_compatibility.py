"""
gwgpu_jax_compatibility.py
=======================
Real-data ingest layer. Bridges between ``gwpy.TimeSeries`` objects and
gwgpu_jax :class:`~gwgpu_jax.gwgpu_jax_interferometer_utils.Interferometer` /
:class:`~gwgpu_jax.gwgpu_jax_network_ifos_utils.Network` instances.
...
def attach_data_to_network(
    ...
    """
    from gwgpu_jax.gwgpu_jax_psd_utils import psd_from_data  # local import: avoid cycle
