"""
gwgpu_jax_two_phase_sampler.py
===========================
Two-phase nested-sampling driver on top of :class:`GWgpu_jaxNestedSampler`.
...
from gwgpu_jax.gwgpu_jax_prior_definitions import sample_prior


# ── Result container ─────────────────────────────────────────────────────────

class TwoPhaseNestedSamplingResult(NamedTuple):
    """Output bundle from :meth:`GWgpu_jaxTwoPhaseNestedSampler.run_two_phase`."""
...
class GWgpu_jaxTwoPhaseNestedSampler(GWgpu_jaxNestedSampler):
    """Two-phase variant of :class:`~gwgpu_jax.gwgpu_jax_samplers.GWgpu_jaxNestedSampler`.
