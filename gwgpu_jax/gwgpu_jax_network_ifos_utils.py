"""
gwgpu_jax_network_ifos_utils.py
============================
Multi-detector interferometer network.

:class:`Network` combines two or more :class:`~gwgpu_jax.gwgpu_jax_interferometer_utils.Interferometer`
instances that share the same :class:`~gwgpu_jax.gwgpu_jax_timefrequencydomain_utils.TimeFrequencyGrid`.
...
class Network:
    ...
    def __init__(self, interferometers: Sequence[Interferometer]) -> None:
        ...
        # ``gwgpu_jax.compat.attach_event_to_network``. Samplers default to this
