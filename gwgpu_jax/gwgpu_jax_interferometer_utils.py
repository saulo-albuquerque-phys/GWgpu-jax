"""
gwgpu_jax_interferometer_utils.py
==============================
...
from gwgpu_jax.gwgpu_jax_psd_utils import get_psd, _PSD_REGISTRY
...
class Interferometer:
    ...
    def antenna_pattern(
        ...
        gmst : float [rad]  Greenwich Mean Sidereal Time. Pass the trigger
                            ...
                            :func:`gwgpu_jax.compat.attach_event_to_network`)
    ...
    def time_delay_from_geocenter(
        ...
        **negative** value means the detector is closer to the source and
        ...
        :func:`gwgpu_jax.gwgpu_jax_likelihood_utils.waveform_projection_fd`, this
        ...
        :func:`gwgpu_jax.gwgpu_jax_samplers.build_ripplegw_waveform_fn` — it forces
    ...
    # ── Likelihood / SNR (delegate to gwgpu_jax_likelihood_utils) ─────────────────
