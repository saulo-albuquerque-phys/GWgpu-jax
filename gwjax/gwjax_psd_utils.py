...
gwjax_psd_utils.py
==================
Power Spectral Density (PSD) utilities for GWjax interferometers.
...
def psd_from_data(
    ...
    target_freqs : array-like, optional
        ...
        :class:`~gwjax.gwjax_interferometer_utils.Interferometer`.
    ...
    >>> from gwjax.gwjax_psd_utils import psd_from_data
    >>> import numpy as np
