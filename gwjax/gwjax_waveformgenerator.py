"""
gwjax_waveformgenerator.py
==========================
Unified waveform generator that wraps all three GWjax backends under a single
...
Usage
-----
>>> from gwjax.gwjax_waveformgenerator import GWjaxWaveformGenerator
...
>>> gen = GWjaxWaveformGenerator("ripplegw")
...
>>> gen = GWjaxWaveformGenerator("mlgw_bbh_jax")
...
>>> gen = GWjaxWaveformGenerator("mlgw_bns_jax")
...
# ── GWjax sub-generators (lazy imports handled inside __init__) ───────────────
...
class GWjaxWaveformGenerator:
    """Unified front-end for the three GWjax waveform backends.
